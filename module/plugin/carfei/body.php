...
<body>
    <div class="container-fluid">
        <div class="row-fluid">
            <hr>
                    <p>
                        <a class="btn btn-primary btn-large" href="?qianfei/car_usr">查看车位欠费情况</a>&ensp; <button id="btn-add-usr" type="button" class="btn btn-primary">添加用户</button>
                    </p>
                            ...
                            for (var i = 0; i < 100; i++) {
                                if ($("#i-" + i).length > 0) {
                                    ...
                                    $("#i-" + i).on("click", function () {
                                        ...
                                        $.post("?find/carfei/lou/" + data, {}, function (data, status) {
                                            ...
                                            for (var i = 0; i < 100; i++) {
                                                ...
                                                if ($("#f-" + i).length > 0) {
                                                    ...
                                                    $("#f-" + i).on("click", function () {
                                                        var data = $(this).attr("data");
                                                        console.log("?find/carfei/lou/" + $(".tmp").attr("data") + "/" + data);
                                                        $.post("?find/carfei/lou/" + $(".tmp").attr("data") + "/" + data, {
                                                            //表现为具体层数
                                                                ...
                                                                if ($(".h-" + i).length > 0) {
                                                                    ...
                                                                    //$(document).ready(function(){
                                                                        ...
                                                                        $(".hu").on('click',".h-" + i,function(){
                                                                            ...
                                                                            $.post('?find/carfei/lou/'+arr[0]+'/'+arr[1]+'/'+arr[2],{
                                                                        ...
                                                                        $(".hu").on('click',".edit-h-" + i,function(){
                                                                            var arr = $(this).attr("data").split('/');
                                                                            $.post('?find/carfei/edit/'+arr[0]+'/'+arr[1]+'/'+arr[2],{
                                                                        ...
                                                                        $(".hu").on('click',".jiaofei-h-" + i,function(){
                                                                            var arr = $(this).attr("data").split('/');
                                                                            $.post('?find/carfei/jiaofei/'+arr[0]+'/'+arr[1]+'/'+arr[2],{
